 ...
 */
 $wp_customize->add_panel( 'footer_section_panel',
   array(
      'title' => __( 'Footer Section','keenshot'),
 ...
 */
 ...
 $wp_customize->add_control( 'keenshot_footer_phone_control',
   ...
   $wp_customize->add_setting( 'keenshot_footer_google_map_settings',
   array(
      'default' => '',
      'transport' => 'refresh',
      'type' => 'theme_mod',
 ...
 $wp_customize->add_control( 'keenshot_footer_google_map_control',
   array(
      'label' => __( 'Google Map' ,'keenshot' ),
      'description' => esc_html__( 'Paste your google map api link','keenshot'),
      'section' => 'keenshot_footer_address',
      'settings' => 'keenshot_footer_google_map_settings',
      'priority' => '',
      'type' => 'url', 
      'capability' => 'edit_theme_options',
      'input_attrs' => array(
         'class' => 'my-custom-class',
         'style' => 'border: 1px solid rebeccapurple',
         'placeholder' => __( 'Enter goole map api link...' ,'keenshot' ),
      ),
     )
   );

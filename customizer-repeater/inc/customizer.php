...
function customizer_repeater_register( $wp_customize ) {
  ...
  $section = [ 'keenshot-skill', 'keenshot-about','keenshot-team','keenshot-slider' , 'keenshot-client-logo','keenshot-contact'];

  foreach($section as $q):
   require get_template_directory().'/customizer-repeater/class/'.$q.'.php';
  endforeach;
 ...
 $wp_customize->add_control( new Keenshot_About_Customizer_Repeater( $wp_customize, '  keenshot_about_us_customizer_control', array(
   ...
   /**
    ...
    array(
       'title' => __( 'Keenshot: Clint Logo','keenshot' ),
       'panel' => 'keenshot_theme_panel', 
       'capability' => 'edit_theme_options', 
       'description_hidden' => 'false', 
    )
 ...
 */
 $wp_customize->add_section( 'about_page_skill_section',
   array(
      'title' => __( 'Keenshot: Manage skil','keenshot' ),
      'panel' => 'keenshot_theme_panel', 
      'capability' => 'edit_theme_options', 
      'description_hidden' => 'false', 
   )
 ...
 $wp_customize->add_control( new Keenshot_Contact_Customizer_Repeater( $wp_customize, '  keenshot_contact_customizer_control', array(
  ...
  /**
    * KEENSHOT SOCIALITE SECTION
    */

    $wp_customize->add_section( 'keenshot_socialite_section',
    array(
       'title' => __( 'Keenshot: Footer Socialite','keenshot' ),
       'panel' => 'keenshot_theme_panel', 
       'capability' => 'edit_theme_options', 
       'description_hidden' => 'false', 
  ...
  $wp_customize->add_setting( 'keenshot_socialite_settings', array(
       'default' => '',
       'transport' => 'refresh',
       'type' => 'theme_mod',
       'capability' => 'edit_theme_options',
  ...
  $wp_customize->add_control( new Keenshot_About_Customizer_Repeater( $wp_customize, '  keenshot_socialite_customizer_control', array(
      'label'   => __('Keenshot: Socialite','keenshot'),
      'section' => 'keenshot_socialite_section',
      'settings' => 'keenshot_socialite_settings',
      'priority' => 110,
      'active_callback' => '',
      'customizer_repeater_repeater_control' => true
    )));
